...
public class ColumnLayout2 extends RelativeLayout implements FlowableTextView.FlowableViewFactory {
    ...
    public ColumnLayout2(Context context) {
        this(context, null);
    }

    public ColumnLayout2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColumnLayout2(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void measureHeightChildren(int columnWith, int columnHeight) {
        for (int i = 0; i < getChildCount(); i++) {
            View v = getChildAt(i);
            v.setId(6989);
            ColumnLayout2.LayoutParams lp = (LayoutParams) v.getLayoutParams();
            v.measure(
